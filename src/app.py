...
@app.route('/mail')
@jwt_required()#esto hace que en headers autorization tenga el access token
def send_mail():
    msg=Message("Hola un gusto saludarte", sender="curosai80@gmail.com", recipients="atrujilloembry@gmail.com")
    msg.body="Te escribo porque esta es una prueba"
    #msg.html=<html>......
    mail.send(msg)
